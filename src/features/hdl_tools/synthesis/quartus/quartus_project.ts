//Specific Imports
import { ISynthesisProject, SynthesisProject} from "../synthesis_project";
import { QuartusScriptGenerator } from "./quartus_script_generator";
import { Quartus} from "./quartus";
import  {CustomQuartusTclScript, CustomQuartusTclScriptsFolder, QuartusQsf} from "./quartus_package";
import { VhdlEntity } from "../../vhdl_package";
import { HDLUtils } from "../../../utils/hdl/general/hdl_utils";
import { eSynthesisFile, eSynthesisTool } from "../synthesis_package";
...
export class QuartusProject extends SynthesisProject implements ISynthesisProject
{
    ...
    private async HandleFileEvents() : Promise<void>
    {
        ...
        const disposable = vscode.Disposable.from(this.mQsfWatcher);
